...
// TODO: No analog on Pi so set to 25 when used and remove header file
// #include <S5813A.h>
...
void setup() {
	...
	// TODO: Pi2 doesn't have analog input - Wrap this appropriately
	...
	// TODO: Removing all Serial usage as it isn't in wiring yet - Replace once RTM TH2 bits are available
	//Serial.begin(9600);
	delay(500);
	...
	// TODO: No analog on Pi so set to 25 when used
...
void loop() {
	// TODO: No analog on Pi so set to 25 when used
	int temperature = 25 /*S5813A.read()*/;
